...
export const formatStr = {
  ...
  dateSlash: 'DD/MM/YYYY', // 17 Apr 2022
...
export function fDateSlash(date: DatePickerFormat, format?: string) {
  if (!date) {
    return null;
  }
  ...
  return isValid ? dayjs(date).format(format ?? formatStr.dateSlash) : 'Invalid time value';
}
// ----------------------------------------------------------------------
